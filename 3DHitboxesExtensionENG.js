      ...
      return {
        ...
        blocks: [
          ...
          // TRANSFORM BLOCKS (12)
          {
            ...
            text: '📦 create object [ID] type [TYPE]',
            arguments: {
          ...
          
          {
            opcode: 'setPosition',
            blockType: Scratch.BlockType.COMMAND,
            text: '📍 set position [ID] x [X] y [Y] z [Z]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
          ...
          
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: '➕ change position [ID] by x [X] y [Y] z [Z]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
          ...
          
          {
            opcode: 'setRotation',
            blockType: Scratch.BlockType.COMMAND,
            text: '🔄 set rotation [ID] rx [RX] ry [RY] rz [RZ]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
          ...
          
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: '🔄➕ rotate [ID] by rx [RX] ry [RY] rz [RZ]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
              RX: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
          ...
          
          {
            opcode: 'getDistance',
            blockType: Scratch.BlockType.REPORTER,
            text: '📏 distance between [ID1] and [ID2]',
            arguments: {
          ...
          
          {
            opcode: 'addImpulse',
            blockType: Scratch.BlockType.COMMAND,
            text: '⚡ add impulse [ID] x [X] y [Y] z [Z]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
              X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 1 },
              Y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
          ...
          
          {
            opcode: 'setVelocity',
            blockType: Scratch.BlockType.COMMAND,
            text: '🎯 set velocity [ID] x [X] y [Y] z [Z]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
              X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
              Y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
          ...
          
          {
            opcode: 'addTorque',
            blockType: Scratch.BlockType.COMMAND,
            text: '🌀 add torque [ID] x [X] y [Y] z [Z]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
              X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
          ...
          
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: '📦 set collider [ID] w [W] h [H] d [D]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
              W: { type: Scratch.ArgumentType.NUMBER, defaultValue: 10 },
              H: { type: Scratch.ArgumentType.NUMBER, defaultValue: 10 },
          ...
          
          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            text: '💥 contact point [ID1] [ID2] axis [AXIS]',
            arguments: {
              ID1: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
              ID2: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj2' },
              AXIS: { type: Scratch.ArgumentType.STRING, menu: 'axes', defaultValue: 'x' }
          ...
          
          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            text: '⬆️ contact normal [ID1] [ID2] axis [AXIS]',
            arguments: {
              ID1: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
              ID2: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj2' },
              AXIS: { type: Scratch.ArgumentType.STRING, menu: 'axes', defaultValue: 'y' }
          ...
          // RAYCAST BLOCKS (8)
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: '🔫 raycast from [ID] distance [DIST]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
          ...
          
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: '🔫 raycast from x [X] y [Y] z [Z] angle [RY] distance [DIST]',
            arguments: {
              X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
              Y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
              Z: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
          ...
          
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: '🔫 raycast from [ID] direction x [DX] y [DY] z [DZ] distance [DIST]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
          ...
          
          {
            opcode: 'rayNormal',
            blockType: Scratch.BlockType.REPORTER,
            text: '⬆️ raycast normal axis [AXIS]',
          ...
          
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: '🔒 set rotation limit [ID] min [MIN] max [MAX]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'player' },
          ...
          // SIMULATION (8)
          {
            opcode: 'step',
            blockType: Scratch.BlockType.COMMAND,
            text: '⚙️ update physics'
          },
          
          {
            opcode: 'setTimeScale',
            blockType: Scratch.BlockType.COMMAND,
            text: '⏱️ set time scale [SCALE]',
          ...
          
          {
            opcode: 'getDirection',
            blockType: Scratch.BlockType.REPORTER,
            text: '➡️ direction [ID] [DIR] axis [AXIS]',
            arguments: {
              ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'obj1' },
